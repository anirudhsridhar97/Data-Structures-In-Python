# -*- coding: utf-8 -*-
"""
Created on Sat Nov 21 20:09:44 2020
...
Note that the input array is passed in by reference, which means a modification to the input array will 
...
with nums = [2,2,3,3] or nums = [2,3,0,0], your answer will be accepted.
